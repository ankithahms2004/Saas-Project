...
const ListView$1 = lazy(() => import("./ListView-BTv9zbVG.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-BTv9zbVG.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-KrAEvWtO.mjs.map
