...
const indexEVGmgxV1 = require("./index-EVGmgxV1-DuwqBvNN.js");
...
const index = require("./index-BMeoT12i.js");
...
const ProvidersPage = () => {
  ...
  const { trackUsage } = indexEVGmgxV1.useTracking();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(indexEVGmgxV1.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(indexEVGmgxV1.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 3, rowCount: providers.length + 1, children: [
...
//# sourceMappingURL=index-DtNLOcA_.js.map
