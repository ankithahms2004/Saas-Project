...
const command = () => {
  return commander.createCommand("export").description("Export data from Strapi to file").allowExcessArguments(false).addOption(
  ...
  ).addOption(dataTransfer.excludeOption).addOption(dataTransfer.onlyOption).addOption(dataTransfer.throttleOption).hook("preAction", dataTransfer.validateExcludeOnly).hook("preAction", commander$1.promptEncryptionKey).action(action);
};
