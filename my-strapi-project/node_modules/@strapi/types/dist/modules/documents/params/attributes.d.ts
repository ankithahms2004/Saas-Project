...
export type OmitRelationWithoutTarget<TSchemaUID extends UID.Schema, TValue> = Omit<TValue, Exclude<Schema.AttributeNamesByType<TSchemaUID, 'relation'>, Schema.AttributeNamesWithTarget<TSchemaUID>>>;
/**
...
export type GetValue<TAttribute extends Schema.Attribute.Attribute> = If<IsNotNever<TAttribute>, MatchFirst<[
    [
        ...
        TAttribute extends Schema.Attribute.Relation<infer TRelationKind, infer TTarget> ? If<IsNotNever<TTarget>, Schema.Attribute.RelationPluralityModifier<TRelationKind, ID>> : never
    ],
    [
