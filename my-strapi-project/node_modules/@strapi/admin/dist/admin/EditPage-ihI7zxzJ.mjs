...
import { e as errorsTrads, j as useUpdateUserMutation, k as useAdminUsers, F as Form, b as Layouts, B as BackButton, M as MemoizedInputRenderer } from './index-EVGmgxV1.mjs';
import { b as useTypedSelector, P as Page, a as useNotification, e as useAPIErrorHandler, k as useRBAC } from './Theme-MYB9EmPi.mjs';
import { u as useEnterprise } from './useEnterprise-jpsYZWzn.mjs';
import { s as selectAdminPermissions } from './selectors-mpTIoFLW.mjs';
import { i as isBaseQueryError } from './admin-GZ-AP2T0.mjs';
import { g as getDisplayName } from './users-a4KTyEyc.mjs';
import { M as MagicLinkCE, S as SelectRoles } from './SelectRoles-N_Zffa52.mjs';
import { C as COMMON_USER_SCHEMA } from './validation-sPmYkuT8.mjs';
...
const EditPage = () => {
  ...
  const MagicLink = useEnterprise(
    MagicLinkCE,
    async () => (await import('./MagicLinkEE-h4r3dpNp.mjs')).MagicLinkEE
  );
  const {
...
//# sourceMappingURL=EditPage-ihI7zxzJ.mjs.map
