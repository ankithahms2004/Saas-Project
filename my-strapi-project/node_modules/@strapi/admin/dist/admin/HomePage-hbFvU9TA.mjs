...
import { c as useTracking, e as useAPIErrorHandler, a as useNotification, P as Page, n as useAppInfo } from './Theme-MYB9EmPi.mjs';
import { L as LAYOUT_DATA, N as Number, V as VerticalDivider, S as STATES } from './Ornaments-jAwgQeK0.mjs';
import { l as useGuidedTour, b as Layouts } from './index-EVGmgxV1.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-WrlRtByb.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-hbFvU9TA.mjs.map
