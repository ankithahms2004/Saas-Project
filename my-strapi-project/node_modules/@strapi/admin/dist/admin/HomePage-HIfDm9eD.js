...
const index = require('./index-YSRONKO4.js');
...
const HomePage = () => {
  const Page2 = useEnterprise.useEnterprise(
    ...
    async () => (await Promise.resolve().then(() => require('./HomePage-nUs2GWzk.js'))).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-HIfDm9eD.js.map
