...
declare const _default: {
    ...
    assignActionId: (attrs: Omit<Omit<Action, "actionId">, "options"> & Partial<Pick<Omit<Action, "actionId">, "options">> & {
        uid: string;
    }) => Omit<Omit<Action, "actionId">, "options"> & Partial<Pick<Omit<Action, "actionId">, "options">> & {
        uid: string;
    };
    assignOrOmitSubCategory: (action: Action) => Action;
    create: (payload: Omit<Omit<Action, "actionId">, "options"> & Partial<Pick<Omit<Action, "actionId">, "options">> & {
        uid: string;
    }) => Action;
    computeActionId: (attributes: Omit<Omit<Action, "actionId">, "options"> & Partial<Pick<Omit<Action, "actionId">, "options">> & {
        uid: string;
    }) => string;
    getDefaultActionAttributes: () => Partial<Action>;
    sanitizeActionAttributes: (action: Action | (Omit<Omit<Action, "actionId">, "options"> & Partial<Pick<Omit<Action, "actionId">, "options">> & {
        uid: string;
    })) => Action;
};
